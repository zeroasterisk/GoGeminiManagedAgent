...
The fastest path to a running [Agent Platform](https://cloud.google.com/gemini/docs/managed-agents) Managed Agent:
...
**[Agent Platform](https://cloud.google.com/gemini/docs/managed-agents)**
...
full `eve` runtime (Agent Platform provides the equivalent), but the deploy step: a directory *is*
...
> **Note on Availability (as of Sept 2026):**
...
| [`examples/full-featured/`](examples/full-featured/) | All supported tool types in a single reference config. |
